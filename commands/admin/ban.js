...
module.exports = 
{
    ...
    async execute(message, args, cmd, client, Discord)
    {
        ...
        if(!reason) return message.reply(`Please use a reason`)

        const embed = new Discord.MessageEmbed()
        .setTitle(`**__You Have Banned__**`)
        .setDescription(`You have been banned from the LazySensy Community \n\n **Reason**: ${reason} \n **Moderator**: ${message.author.username} \n **Date**: ${new Date().toLocaleDateString()} \n\n If you feel like this is incorrect you can request an appeal through this link (https://forms.gle/tsiEJQdUSdwabjSc6)`)
